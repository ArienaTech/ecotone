        ...
        >
          ...
          <div>
            <div style={{ marginBottom: '12px' }}>
              ...
              <span style={{ fontFamily: 'Inter', fontWeight: 400, fontSize: '11px', color: '#C4902E', letterSpacing: '0.06em', display: 'block', marginTop: '4px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <a
                ...
                onMouseEnter={(e) => (e.currentTarget.style.color = '#C4902E')}
