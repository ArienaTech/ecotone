          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                ...
                <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '28px' }}>
                  {[
                    ...
                    <li key={item} style={{ display: 'flex', gap: '12px', fontFamily: 'Inter', fontWeight: 400, fontSize: '14px', color: '#505050', lineHeight: 1.6 }}>
                      <span style={{ color: '#A78048', fontWeight: 700, flexShrink: 0 }}>✓</span>
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  {[
                    ...
                    <div key={item.heading} style={{ borderLeft: '3px solid #A78048', paddingLeft: '16px' }}>
            ...
            <div style={{ marginBottom: '80px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '2px' }} className="materials-grid five-col">
                {[
                  ...
                  <div key={item.name} style={{ background: '#f5f4f2', padding: '28px 24px', borderTop: '3px solid #A78048' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', marginBottom: '80px' }} className="about-grid two-col">
              <div>
                ...
                <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  {[
                    ...
                    <li key={item} style={{ display: 'flex', gap: '12px', fontFamily: 'Inter', fontWeight: 400, fontSize: '14px', color: '#505050', lineHeight: 1.6 }}>
                      <span style={{ color: '#A78048', fontWeight: 700, flexShrink: 0 }}>✓</span>{item}
                    </li>
                  ))}
                </ul>
              </div>
              <div>
                ...
                <div style={{ background: '#FBF3E4', border: '1px solid #E5C88C', padding: '16px' }}>
                  <p style={{ fontFamily: 'Space Grotesk', fontWeight: 600, fontSize: '14px', color: '#7A5C30', lineHeight: 1.6 }}>
            ...
            <div style={{ background: '#0a0a0a', padding: '56px', marginBottom: '80px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '24px' }} className="materials-grid five-col">
                {[
                  ...
                  <div key={item.step}>
                    <span style={{ fontFamily: 'Space Grotesk', fontWeight: 800, fontSize: '36px', color: '#A78048', display: 'block', marginBottom: '12px', lineHeight: 1 }}>
                      {item.step}
                    </span>
