      ...
      <main style={{ paddingTop: '64px' }}>
        ...
        <section style={{ background: '#ffffff', padding: 'clamp(60px,8vh,100px) 6%' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '28px' }}>
                  {[
                    ...
                    <div key={benefit.title} style={{ borderLeft: '3px solid #A78048', paddingLeft: '16px' }}>
                ...
                <div style={{ background: '#FBF3E4', border: '1px solid #E5C88C', padding: '16px' }}>
                  <p style={{ fontFamily: 'Inter', fontWeight: 400, fontSize: '14px', color: '#7A5C30', lineHeight: 1.65 }}>
            ...
            <div style={{ background: '#f5f4f2', padding: '48px', borderLeft: '4px solid #A78048', marginBottom: '48px' }}>
